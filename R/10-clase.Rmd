...
Podemos ver que tenemos cuatro variables cuantitativas (`ing_t_t`, `edad`, `fact_cal_esi` e `ing_medio`), y tres variables categóricas (`sexo`, `est_conyugal` y `ciuo08`). Estas últimas tienen 2, 2 y 10 categorías, respectivamente. 
